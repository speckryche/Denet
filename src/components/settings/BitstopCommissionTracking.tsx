...
export function BitstopCommissionTracking() {
  ...
  if (isLoading) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Bitstop Commission Tracking</CardTitle>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Bitstop Commission Tracking</CardTitle>
        <CardDescription>
          Track monthly commission reports and payments from Bitstop
        </CardDescription>
      </CardHeader>
      <CardContent>
        {successMessage && (
                  ...
                  <TableRow key={record.id} className="border-white/5">
                    ...
                    <TableCell>
                      <Input
                        ...
                        onChange={(e) => handleFieldChange(record.id, 'total_sales', parseFloat(e.target.value) || 0)}
                        placeholder="0.00"
                        className="bg-card border-white/10"
                      />
                    </TableCell>
                    <TableCell>
                      <Input
                        ...
                        onChange={(e) => handleFieldChange(record.id, 'commission_amount', parseFloat(e.target.value) || 0)}
                        placeholder="0.00"
                        className="bg-card border-white/10"
                      />
                    </TableCell>
